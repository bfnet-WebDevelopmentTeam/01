...
<nav class="llms-course-navigation">
	...
	<?php if ( ! $prev_id || ! $next_id ) : ?>
		<div class="llms-course-nav llms-back-to-course <?php if(! $next_id) {echo 'llms-last-to-course';} ?>">
			<div class="llms-lesson-preview">
				<a class="llms-lesson-link" href="<?php echo get_permalink( $lesson->get( 'parent_course' ) ); ?>">
					<section class="llms-main">
						<h6 class="llms-pre-text"><?php echo __( 'コースへ戻る', 'lifterlms' ); ?></h6>
